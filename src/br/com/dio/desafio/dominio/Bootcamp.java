...
public class Bootcamp {
	...
	private Set<Dev> devsInscrito = new LinkedHashSet<>();
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dataFinal, dataInicial, descricao, devsInscrito, nome);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(conteudos, other.conteudos) && Objects.equals(dataFinal, other.dataFinal)
				...
				&& Objects.equals(devsInscrito, other.devsInscrito) && Objects.equals(nome, other.nome);
	}
